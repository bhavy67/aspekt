...
import type { Category, Wallpaper } from '@aspekt/types';
import { Screen } from '../../../../components/screen';
import { darkTheme, lightTheme } from '../../../../lib/theme';
import { getCategory, getWallpapersByCategory } from '../../../../lib/queries';
...
export default function CategoryScreen() {
  ...
  useEffect(() => {
    if (slug) {
      Promise.all([getCategory(slug), getWallpapersByCategory(slug)]).then(([cat, items]) => {
        setCategory(cat);
        setWallpapers(items);
        setLoading(false);
      });
